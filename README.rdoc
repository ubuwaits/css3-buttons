...
Some of these buttons are using the Iconic icon set (http://somerandomdude.com/projects/iconic/) by P.J. Onori, via the method described here: http://somerandomdude.com/articles/design-technology/font-embedding-icons
